...
**Hypothèse :**
Nous nous intéressons maintenant aux facteurs météorologiques comme le vent, la couverture nuageuse, les précipitations... et sur leur impact sur les durées moyennes de trajets. Nous souhaitons voir si le mauvais temps défavorise l'utilisation des vélos. Nous supposons donc que la durée moyenne de trajet devrait être plus courte les jours de mauvais temps.
...
La troisième visualisation met en relation les précipitations et la durée moyenne des trajets afin d'observer si la neige a un impact sur l'utilisation des vélos des usagers. La grande majorité des observations se trouvent à 0 de précipitations, où la durée moyenne des trajets est très variable. Ceci peut s'expliquer parce que les utilisateurs ne souhaitent juste pas faire du vélos quand il pleut. 

La dernière visualisation montre une hausse légère de la durée moyenne des trajets vers 20 km/h de vent. C'est assez minime il n'y a pas beaucoup d'influence du vent sur la durée moyenne. 
